...
# x is a data frame of the consensus matrix. 
#need to make robust to bug when names start with numbers...
...
###y is a dataframe of cluster identities for various k in 
    ###columns and rownames as cells
